...
- [x] 2.3 `generateStructured` body includes `response_format.json_schema.strict=true` — 6b4ad84
...
- [x] 3.1 Suite passes with no key (live smoke skipped, not failed) — 6b4ad84
- [x] 3.2 Mock-transport tests cover happy/structured/error/malformed/timeout-translation + bean-timeout-wiring assertion — 6b4ad84
- [x] 3.3 `render.yaml` parses with secret `LLM_API_KEY` entry — 6b4ad84

#### Manual

- [x] 3.4 Real-key smoke test returns a coherent Gemini completion within timeout — 6b4ad84
- [x] 3.5 Real/non-synthetic data uses the paid no-training tier — 6b4ad84
