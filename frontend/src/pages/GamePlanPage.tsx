            ...
            <div style={s.planCard}>
              <div style={s.planProse}>
                <ReactMarkdown
                  components={{
                    p: ({ children }) => (
                      <p style={{ margin: '0 0 0.75rem', lineHeight: 1.8 }}>{children}</p>
                    ),
                    strong: ({ children }) => (
                    ...
                    ul: ({ children }) => (
                      <ul style={{ margin: '0 0 0.75rem', paddingLeft: '1.5rem' }}>{children}</ul>
                    ),
                    ol: ({ children }) => (
                      <ol style={{ margin: '0 0 0.75rem', paddingLeft: '1.5rem' }}>{children}</ol>
                    ),
                    li: ({ children }) => (
