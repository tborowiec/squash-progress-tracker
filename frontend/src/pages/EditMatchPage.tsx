...
import MatchForm, { MatchFormInitial } from '../components/MatchForm'
...
const s: Record<string, React.CSSProperties> = {
  ...
  notFoundMsg: { fontFamily: 'var(--font-display)', fontSize: '1.5rem', color: 'var(--muted)', marginBottom: '1rem' },
        ...
        <div style={s.card}>
          {loading ? (
            ...
            <div style={s.notFound}>
              ...
              <Link to="/history" style={s.backLink}>← Back to history</Link>
            </div>
          ) : (
            <MatchForm
              initial={initial!}
