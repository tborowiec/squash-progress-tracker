...
function resultStyle(result: string): React.CSSProperties {
  if (result === 'WON')
    return { ...s.badge, background: 'rgba(0,201,167,0.12)', color: 'var(--teal)' }
  if (result === 'LOST')
    return { ...s.badge, background: 'rgba(248,113,113,0.1)', color: 'var(--error)' }
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          color: 'var(--error)',
                          fontWeight: 700,
                          opacity: deletingId === match.id ? 0.6 : 1,
                        }}
